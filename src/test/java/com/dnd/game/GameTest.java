...
class GameTest {
    ...
    @Test
    void player_moves_forward_by_dice_roll() throws CharacterOutOfBoundsException {
    ...
    void game_throws_when_roll_exceeds_board() {
        ...
        assertThrows(CharacterOutOfBoundsException.class, game::playOneTurn);
    }

    @Test
    void game_is_won_at_last_tile() throws CharacterOutOfBoundsException {
    ...
    void hero_can_take_damage() {
        ...
        assertEquals(0, hero.getLifePoints());
    }
}
